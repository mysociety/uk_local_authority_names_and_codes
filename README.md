...
An easier to download version of this can be found at [`https://mysociety.github.io/uk_local_authority_names_and_codes/`][1].

[1]: https://mysociety.github.io/uk_local_authority_names_and_codes/
...
* `gss-code` – current standard 9-character ONS code. [^1]
...
[^1]: The GSS code used for the Greater London Authority is the GSS code is for London region – when working from code point open use E18000007 and the `NHS_HA_code` column.
...
| Whether Lower or Unitary | Count |
|--------------------------|------:|
| No                       |    36 |
| Yes                      |   361 |
| All                      |   397 |
