...
custom:
  ...
  datasette:
    ...
    about_url: https://pages.mysociety.org/uk_local_authority_names_and_codes/datasets/uk_la_past_current/1_3_0
  formats:
    csv: true
    parquet: true
resources:
- title: UK Local Authorities (past/current)
  ...
  custom:
    ...
    datasette:
      about: Info & Downloads
      about_url: https://pages.mysociety.org/uk_local_authority_names_and_codes/datasets/uk_la_past_current/1_3_0#uk_local_authorities_current
  ...
  schema:
    ...
    - name: wdtk-id
      ...
      example: 3.0
  _sheet_order: 1
  hash: f4c27a990baf5bee77383c4c25dcf112
- title: GSS to local authority code lookup
  ...
  custom:
    ...
    datasette:
      about: Info & Downloads
      about_url: https://pages.mysociety.org/uk_local_authority_names_and_codes/datasets/uk_la_past_current/1_3_0#lookup_gss_to_registry
...
- title: LSOA to local authority code lookup
  ...
  custom:
    ...
    datasette:
      about: Info & Downloads
      about_url: https://pages.mysociety.org/uk_local_authority_names_and_codes/datasets/uk_la_past_current/1_3_0#lookup_lsoa_to_registry
...
- title: Name to local authority code lookup
  ...
  custom:
    ...
    datasette:
      about: Info & Downloads
      about_url: https://pages.mysociety.org/uk_local_authority_names_and_codes/datasets/uk_la_past_current/1_3_0#lookup_name_to_registry
