...
custom:
  ...
  datasette:
    ...
    about_url: https://pages.mysociety.org/uk_local_authority_names_and_codes/datasets/uk_la_future/1_7_1
  formats:
    csv: true
    parquet: true
resources:
- title: UK Local Authorities (past/current/future)
  ...
  custom:
    ...
    datasette:
      about: Info & Downloads
      about_url: https://pages.mysociety.org/uk_local_authority_names_and_codes/datasets/uk_la_future/1_7_1#uk_local_authorities_future
  ...
  schema:
    ...
    - name: wdtk-id
      ...
      example: 3.0
  _sheet_order: 1
  hash: 1c80dd58df10ab1569bc67fc9391bd6c
- title: Lookup table for local authority names to local authority codes (includes
  ...
  custom:
    ...
    datasette:
      about: Info & Downloads
      about_url: https://pages.mysociety.org/uk_local_authority_names_and_codes/datasets/uk_la_future/1_7_1#lookup_name_to_registry
